    ...
    return (
        <div className='blogs'>
            ...
            <div className="blog card ">
                <h2 className='text-success'>What Is Context API ?</h2>
            ...
            <div className="blog card">
                <h2 className='text-success'>What is Semantic Tag?</h2>
            ...
            <div className="blog card ">
                <h2 className='text-success'>Difference Between Inline and Inline Block Element?</h2>
